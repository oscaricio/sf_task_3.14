...
[Example]: https://git-scm.com/docs/user-manual
Это основы использования Git. Для более подробной информации обратитесь к официальной документации Git по ссылке [Example][].